...
def test_component_renders_correctly():
    ...
    assert str_to_etree(page) == str_to_etree(
        f"<!DOCTYPE html><html><head><meta charset='utf-8'><meta name='viewport' content='width=device-width' initial-scale='1'></head><body><div attr-1='red' attr-2='hello world' attr-3='0'>0<div>Taki</div></div><div>teste1</div><div>teste2</div><ol></ol></body></html>"
    )
